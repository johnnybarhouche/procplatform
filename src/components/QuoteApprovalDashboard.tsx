    ...
    <div className="space-y-6">
      ...
      <div className="bg-white shadow-sm border-b">
        <div className="px-6 py-4">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl font-bold text-gray-900">Quote Approvals</h1>
              <p className="text-gray-600">Review and approve quote packs for your Material Requests</p>
            </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div className="bg-white p-6 rounded-lg shadow">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-2xl font-bold text-blue-600">{(quoteApprovals || []).length}</p>
      ...
      <div className="bg-white shadow rounded-lg">
        <div className="px-6 py-4 border-b border-gray-200">
          <h3 className="text-lg font-semibold text-gray-900">Quote Approvals</h3>
        </div>
        <div className="divide-y divide-gray-200">
          {sortedApprovals.length === 0 ? (
            <div className="px-6 py-12 text-center">
              ...
              <h3 className="mt-2 text-sm font-medium text-gray-900">No quote approvals</h3>
              <p className="mt-1 text-sm text-gray-500">No quote packs are currently pending your approval.</p>
            </div>
          ) : (
