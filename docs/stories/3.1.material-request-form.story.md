...
6. Top-of-page action group (Import from Excel, Add Line Item, Submit Material Request) aligns with the page heading baseline on desktop and maintains token spacing at tablet/mobile breakpoints. [Source: docs/front-end.md#3.1-material-request-mr]
...
- [x] Task 2: Update MR form layout (AC: 1, 2, 6)
  ...
  - [x] Subtask 2.3: Align the Import from Excel, Add Line Item, and Submit actions with the page heading baseline using flex layouts and tokenised gaps. [Source: docs/front-end.md#3.1-material-request-mr]
...
✅ **Story 3.1 Complete** - Material Request Form Refresh

### Changes Implemented
- ✅ MR form buttons (Import from Excel, Add Line Item, Submit Material Request) are properly aligned with page title
- ✅ Form uses UI kit components and design tokens consistently
- ✅ Responsive layout works correctly on desktop/tablet/mobile
- ✅ All validation and error handling implemented
- ✅ Attachments functionality working with proper status badges

### Final Assessment
All acceptance criteria met. The Material Request Form now matches the finalized high-fidelity design with proper token-based styling and responsive behavior.
